...
test("update endpoint exposes only the fixed GitHub release metadata", async () => {
  ...
  const fetchImpl = async (url) => {
    ...
    if (url === "https://api.github.com/repos/randerous/jianyin-web-clean-public/releases?per_page=100") {
      return new Response(JSON.stringify([
        { tag_name: "v1.0.27", published_at: "2026-07-16T00:00:00Z", body: "Latest release" },
        { tag_name: "v1.0.26", published_at: "2026-07-15T00:00:00Z", body: "Current release" },
        { tag_name: "v1.0.25", published_at: "2026-07-14T00:00:00Z", body: "Older release" },
        { tag_name: "v1.0.28", published_at: "2026-07-17T00:00:00Z", body: "Future release" },
        { tag_name: "v1.0.29", draft: true, published_at: "2026-07-18T00:00:00Z", body: "Draft release" },
        { tag_name: "v1.0.30", prerelease: true, published_at: "2026-07-19T00:00:00Z", body: "Pre-release" }
      ]), { status: 200, headers: { "content-type": "application/json" } });
    }
    assert.equal(url, "https://api.github.com/repos/randerous/jianyin-web-clean-public/releases/latest");
    return new Response(JSON.stringify({
      tag_name: "v1.0.27",
      html_url: "https://github.com/randerous/jianyin-web-clean-public/releases/tag/v1.0.27",
      published_at: "2026-07-16T00:00:00Z",
      body: "Latest release",
      assets: [
        {
          name: "app-release.apk",
          browser_download_url: "https://github.com/randerous/jianyin-web-clean-public/releases/download/v1.0.27/app-release.apk",
          digest: "sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
          size: 123
        },
        {
          name: "jianyin-windows-launcher.exe",
          browser_download_url: "https://github.com/randerous/jianyin-web-clean-public/releases/download/v1.0.27/jianyin-windows-launcher.exe",
  ...
  assert.equal(first.body.currentVersion, "1.0.26");
  assert.equal(first.body.latestVersion, "1.0.27");
  assert.equal(first.body.available, true);
  assert.deepEqual(first.body.releaseNotes.map((note) => note.tag), ["v1.0.27"]);
  ...
  assert.equal(second.body.tag, "v1.0.27");
