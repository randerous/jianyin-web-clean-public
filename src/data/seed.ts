...
export const demoLrc = `[00:00.00]既见
[00:03.00]既见君子，云胡不喜
[00:08.00]搜索、播放、队列、歌词和歌单
[00:13.00]本地文件保存在你的设备里`;

export const seedSongs: Song[] = [
  ["jay", "周杰伦 本地试听", "既见示例曲库", 1],
  ["eason", "陈奕迅 本地试听", "既见示例曲库", 2],
  ["jj", "林俊杰 本地试听", "既见示例曲库", 3],
  ["mayday", "五月天 本地试听", "既见示例曲库", 4],
  ["gem", "邓紫棋 本地试听", "既见示例曲库", 5],
  ["balloon", "告白气球 本地试听", "既见示例曲库", 6],
  ["tenyears", "十年 本地试听", "既见示例曲库", 7],
  ["ordinary", "平凡之路 本地试听", "既见示例曲库", 8]
